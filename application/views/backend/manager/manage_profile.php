    ...
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
                ...
                <?php echo form_open(site_url('manager/manage_profile/update_profile_info/'.$row['id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
    ...
    <div class="col-xl-5">
        <div class="card">
            <div class="card-body">
                ...
                <?php echo form_open(site_url('manager/manage_profile/change_password/'.$row['id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="form-group">
