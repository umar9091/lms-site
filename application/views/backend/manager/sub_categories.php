...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('manager/categories'); ?>"><?php echo get_phrase('categories'); ?></a> </li>
    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                <div class="row">
                    <form class="" action="<?php echo site_url('manager/sub_categories_by_category_id'); ?>"
                        method="post">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo site_url('manager/sub_category_form/add_sub_category'); ?>"
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-default" role="menu">
                                        <li>
                                            <a
                                                href="<?php echo site_url('manager/sub_category_form/edit_sub_category/'.$sub_category['id']); ?>">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="confirm_modal('<?php echo site_url('manager/sub_categories/'.$selected_category_id.'/delete/'.$sub_category['id']); ?>');">
