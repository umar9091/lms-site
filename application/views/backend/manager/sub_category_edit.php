...
<ol class="breadcrumb bc-3">
    ...
    <li><a href="<?php echo site_url('manager/sub_categories'); ?>"><?php echo get_phrase('sub_categories'); ?></a>
    </li>
    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                <form action="<?php echo site_url('manager/sub_categories/0/edit/'.$sub_category_id); ?>" method="post"
