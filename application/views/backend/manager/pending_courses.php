                        ...
                        <tr>
                            ...
                            <td hidden>
                                <ul style="list-style-type:square">
                                    ...
                                    <a
                                        href="<?php echo site_url('manager/watch_video/'.slugify($lesson['title']).'/'.$lesson['id']); ?>">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="<?php echo site_url('manager/sections/'.$course['id']); ?>">
                                                <?php echo get_phrase('manage_section');?>
                                            </a>
                                        </li>

                                        <li>
                                            <a href="<?php echo site_url('manager/lessons/'.$course['id']); ?>">
                                        ...
                                        <li>
                                            ...
                                            <?php else: ?>
                                            <a href="#"
                                                onclick="confirm_modal('<?php echo site_url();?>manager/change_course_status_for_admin/active/<?php echo $course['id'];?>', 'generic_confirmation');">
                                                <?php echo get_phrase('mark_as_active');?>
                                            </a>
                                            <?php endif; ?>
                                        </li>
                                        ...
                                        <li>
                                            <a
                                                href="<?php echo site_url('manager/course_form/course_edit/'.$course['id']) ?>">
                                        ...
                                        <li>
                                            <a href="#"
                                                onclick="confirm_modal('<?php echo site_url('manager/course_actions/delete/'.$course['id']); ?>');">
...
function ajax_get_sub_category(category_id) {
    $.ajax({
        url: '<?php echo site_url('manager/ajax_get_sub_category/');?>' + category_id,
