...
?>
<form action="<?php echo site_url('manager/quiz_questions/'.$param3.'/edit/'.$param2); ?>" method="post" id='mcq_form'>
...
function showOptions(number_of_options) {
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('manager/manage_multiple_choices_options'); ?>",
        data: {
...
$('#submitButton').click(function(event) {
    $.ajax({
        url: '<?php echo site_url('manager/quiz_questions/'.$param3.'/edit/'.$param2); ?>',
        type: 'post',
