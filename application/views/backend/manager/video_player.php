...
?>
<ul class="breadcrumb">
    <li><a href="<?php echo site_url('manager/dashboard'); ?>" class=""><?php echo get_phrase('dashboard'); ?></a> </li>
    <li><a
            href="<?php echo site_url('manager/lessons/').$lesson_details['course_id']; ?>"><?php echo get_phrase('lessons'); ?></a>
    </li>
