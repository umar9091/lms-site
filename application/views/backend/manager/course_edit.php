        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo site_url('manager/preview/' . $course_id); ?>"
                        ...
                        <a href="<?php echo site_url('manager/courses'); ?>"
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form"
                            action="<?php echo site_url('manager/course_actions/edit/' . $course_id); ?>" method="post"
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <div class="m-2">
                                                            ...
                                                            <a href="javascript:void(0)"
                                                                onclick="confirm_modal('<?php echo site_url('manager/remove_an_instructor/' . $course_details['id'] . '/' . $instructor_details['id']); ?>');"
